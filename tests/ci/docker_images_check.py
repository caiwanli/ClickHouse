...
class DockerImage:
    def __init__(
        ...
        path: str,
        repo: str,
        parrent: Optional["DockerImage"] = None,
    ...
    def __repr__(self):
        return f"DockerImage(path={self.path},path={self.path},parrent={self.parrent})"
...
def get_changed_docker_images(
    ...
    # With reversed changed_images set will use images with parrents first, and
    # images without parrents then
...
def process_image_with_parrents(
    ...
    if image.parrent is not None:
        result += process_image_with_parrents(image.parrent, versions, push, False)
        child = True
...
def main():
    ...
    for image in changed_images:
        images_processing_result += process_image_with_parrents(
